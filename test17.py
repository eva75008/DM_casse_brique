...
def draw():
    ...
    if life > 0:
        ...
        pyxel.circ(ball_x, ball_y, 3, 7)
            ...
            # plateau (rect 20,4)
        pyxel.tri(plateau_x, plateau_y, plateau_x, plateau_y+3, plateau_x-5, plateau_y+3, 10)
        pyxel.rect(plateau_x, plateau_y, 20, 4, 10)
        pyxel.tri(plateau_x+20, plateau_y, plateau_x+20, plateau_y+3, plateau_x+25, plateau_y+3, 10)
